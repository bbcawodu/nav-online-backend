...
from conftest import TEST_INTENT_SNAPSHOT_VALUES
from conftest import combinations
from http_server_pkg.tests.test_views.base import HTTPServerViewsBaseTestCase


class BrowsingIntentSnapshotTestCase(HTTPServerViewsBaseTestCase, unittest.TestCase):
    base_url = 'v1/presence_health/browsing_intent_snapshot/'
